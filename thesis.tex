...
\end{equation}
で与えられる\cite{tatsumiKiso}。$g=9.8, k=\frac{2\pi}{\lambda}=\frac{2pi}{6.0}, h=3.0$を代入すると$\omega~3.18$である。これより周期は$\frac{2\pi}{3.18}~1.98$となる。実験で得られた周期はおよそ2.0であるためまず水面波を大方再現しているものと考えられる。
\label{subsec:label}
