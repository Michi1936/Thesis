...
{\fontfamily{ptm}\fontseries{m}\fontshape{it}\fontsize{10.5pt}{12.6pt}\selectfont 2018 Department of Physics, Kyoto University}
}
\end{abstract}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{\kanjifamily{mc}\kanjiseries{m}\fontsize{10.5pt}{14pt}\selectfont 
 ...
 \begin{figure}[h]
   \begin{center}
     \includegraphics[width=50truemm]{abstractImg.png}
